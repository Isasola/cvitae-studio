...
values
  ('ops-console',         'OPS Console UI',         'component', 'Your ops. One screen.',          'A full-featured admin panel React component. Brief room, users, content, tokens — all in one dark terminal.',        19, 'USD', '/products/ops-console-screenshot.png',  '/products/ops-console-demo.gif',  null, '/demo/ops-console', null, ARRAY['admin','dashboard','react'], 'available', 1),
